...
QT_MOC_LITERAL(1, 5, 19), // "demostration_signal"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 9), // "demo_name"
QT_MOC_LITERAL(4, 36, 21) // "on_pushButton_clicked"

    },
    "Demo\0demostration_signal\0\0demo_name\0"
...
void Demo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->demostration_signal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (Demo::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Demo::demostration_signal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Demo::demostration_signal(QString _t1)
{
